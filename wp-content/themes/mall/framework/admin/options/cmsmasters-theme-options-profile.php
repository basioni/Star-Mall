...
function get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] : esc_html__('Profile details', 'mall');
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'mall'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'mall'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'mall'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'mall'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'mall'), 
			'desc'	=> '', 
